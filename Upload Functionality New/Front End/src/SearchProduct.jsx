  ...
  const searchByAvailability = async () => {
    try {
      const response = await axios.get(
        `/products/searchAvailability/${availability}`
      );
      setSearchResults(response.data);
    } catch (error) {
      console.error("Error searching by availability:", error);
      ...
      <div className="search-product-form">
        ...
        <div className="form-group">
          <input
            ...
            className="search-input"
          />
          <button onClick={searchByName} className="search-btn">
            Search
          </button>
        </div>
        ...
        <div className="form-group">
          ...
          <button onClick={searchByAvailability} className="search-btn">
            Search
          </button>
        </div>
        ...
        <div className="form-group">
          <input
            ...
            className="search-input"
          />
          <button onClick={searchByPrice} className="search-btn">
            Search
          </button>
        </div>
      </div>
